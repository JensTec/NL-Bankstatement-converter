...
path = "/Users/John/Downloads"  # path where the csv files are saved
csvfile = ""
filename = ""
bank = ""
visa_file = ""
...
def visa():
    ...
    for row in intermediate:  # this function cleans each row, and writes final data
        ...
        amount = rowsplit[length-1].replace(",", ".")   # convert amount with comma to decimal point
...
# ------------ start menu ---------------------------
print("")
print("Welcome to the GNU-Cash bank files converter - made by JensTec (version 1.1)")
menu()
